...
export default class ShapeStyle {
    ...
    static SELECTED_STYLE = new ShapeStyle(Color.SELECTED, ShapeStyle.SOLID, 3);
    static HIGHLIGHTED_STYLE = new ShapeStyle(Color.BLACK, ShapeStyle.SOLID, 3);
    static ERROR_STYLE = new ShapeStyle(Color.RED, ShapeStyle.SOLID)
    static DEFAULT_STYLE = new ShapeStyle(Color.BLACK, ShapeStyle.SOLID, 1)
